...
/* 
 找到Swift Compiler - Search Paths 下的 Use Legacy Swift Language Version:把后面的改成YES。
...
SWIFT_VERSION*/
/*
 找到Swift Compiler - Search Paths 下的 Use Legacy Swift Language Version:把后面的改成NO。
//:configuration = Debug
SWIFT_VERSION = 3.0
...
/*
 Xcode8，新建立工程，都会打印一堆莫名其妙看不懂的Log.
 如这些
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "hzmr-tech.com.BasicFrameworkWithSwift" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("BasicFrameworkWithSwift", withExtension: "momd")!
